...
test_recipes_sheet_data = [["Fruit Salad", "Apples", "Bananas"], ["Apple pie", "Apples", "Flour", "dark chocolate"]]
...
test_recipes = {"Fruit salad": ["Apples", "Bananas"]}
...
class TestData(unittest.TestCase):
    ...
    def test_get_recipes_sheet_data(self, mock_spreadsheet, mock_stdout):
        ...
        expected_dict = {
            "Fruit Salad": {"quantity": 0, "group": "recipes", "ingredient_list": ["Apples", "Bananas"]},
            "Apple pie": {"quantity": 0, "group": "recipes", "ingredient_list": ["Apples", "Flour", "dark chocolate"]},
        }
